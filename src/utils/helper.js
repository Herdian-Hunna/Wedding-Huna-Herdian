...
export const getQueryParameter = (parameterName) => {
    try {
        ...
        // Decode URL component to handle special characters like %20
...
export const setQueryParameter = (parameterName, value) => {
    try {
        const url = new URL(window.location.href);
        url.searchParams.set(parameterName, encodeURIComponent(value));
        return url.toString();
    } catch (error) {
...
export const getGuestName = () => {
    return getQueryParameter('to') || 'Tamu Undangan';
}